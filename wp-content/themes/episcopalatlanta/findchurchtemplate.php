<?php /* Template Name: FindChurchTemplate */ ?>
<?php
...
<div class="dummy-google-review-container" style="display: none;">
          <div class="google-reviews">

                  <div class="author_pic_div auth_cont">
                    <a target="_blank" class="auth_url_link" href="javascript:void(0)">
        ...
        <div class="dummy-chr-slider-container" style="display: none;">
        ...
        <div class="dummy_more_auth_review_btn" style="display: none;">
          <div class="more_auth_review_btn">
            <a class="btn_links btn_link1" target="_blank" href="javascript:void(0)">Read more reviews</a>
          </div>
        </div>
  	...
  	<div id="imaginary_container">
  		<div class="srch_title">Search</div> 
                <div class="input-group schurch_params stylish-input-group">
                    <input type="text" class="form-control church_srh_query" placeholder="Name, City, zip, etc." id="church_search">
        ...
        usort($service_time,'custom_sort_asc_value');
          ...
          <div class="church_search_divider chrch_list_siblings"></div>
            ...
            <div class="custom_loader" style="display: none; background-image: url(<?php echo get_site_url().'/wp-content/themes/episcopalatlanta/images/cust_loader.gif'?>);"></div>
        ...
        $args = array( 'post_type' => 'church', 'posts_per_page' => -1 );
          ...
          $ch_phn = get_post_meta($post->ID, 'phone_number', true);
                    $ch_descrip = get_post_meta($post->ID, 'ch_descrip', true);
                    $ch_social_1 = get_post_meta($post->ID, 'ch_social_1', true);
                    $ch_social_1_url = get_post_meta($post->ID, 'ch_social_1_url', true);
                    $ch_social_2 = get_post_meta($post->ID, 'ch_social_2', true);
                    $ch_social_2_url = get_post_meta($post->ID, 'ch_social_2_url', true);
                    $ch_social_3 = get_post_meta($post->ID, 'ch_social_3', true);
                    $ch_social_3_url = get_post_meta($post->ID, 'ch_social_3_url', true);
          ...
          $plc_id = get_post_meta($post->ID, 'place_id', true);
                    $ch_ministries_1 = get_post_meta($post->ID, ' ch_ministries_1', true);
                    $ch_ministries_2 = get_post_meta($post->ID, ' ch_ministries_2', true);
                    $ch_ministries_3 = get_post_meta($post->ID, ' ch_ministries_3', true);
                    $ch_ministries_4 = get_post_meta($post->ID, ' ch_ministries_4', true);
                    $ch_ministries_5 = get_post_meta($post->ID, ' ch_ministries_5', true);
					$ch_na = get_the_title();
        ...
        if(!empty($ch_ministries_1)){
            array_push($chmini, $ch_ministries_1);
        }
        if(!empty($ch_ministries_2)){
            array_push($chmini, $ch_ministries_2);
        }
        if(!empty($ch_ministries_3)){
            array_push($chmini, $ch_ministries_3);
        }
        if(!empty($ch_ministries_4)){
            array_push($chmini, $ch_ministries_4);
        }
        if(!empty($ch_ministries_5)){
            array_push($chmini, $ch_ministries_5);
        }
        ...
        // usort($sstime,'custom_sort_asc_value');
          ...
          $church_data[]=[
            ...
            'ch_social_1' => $ch_social_1,
            'ch_social_1_url' => $ch_social_1_url,
            'ch_social_2' => $ch_social_2,
            'ch_social_2_url' => $ch_social_2_url,
            'ch_social_3' => $ch_social_3,
            'ch_social_3_url' => $ch_social_3_url,
            'ch_ministries_1' => $ch_ministries_1,
            'ch_ministries_2' => $ch_ministries_2,
            'ch_ministries_3' => $ch_ministries_3,
            'ch_ministries_4' => $ch_ministries_4,
            'ch_ministries_5' => $ch_ministries_5,
              'stime1'=> $sh_t1,
             'stime2'=> $sh_t2,
             'stime3'=> $sh_t3,
             'stime4'=> $sh_t4,
              ...
              <div class="chr_detail_container">
                ...
                <div class="chr_detail_address">
                  ...
                  <div class="chr_detail_phone">
                      <a href="javascript:void(0)"><i class="fa fa-phone"></i>(404) 881-0835</a>
                  </div>
                  <div class="chr_detail_website">
                      <a target="_blank" href="javascript:void(0)"><i class="fa fa-link"></i> Website</a>
                  </div>
      ...
      if (jQuery("#"+autocompleteId).length) {
        ...
        var geocoder = new google.maps.Geocoder;
          ...
          // });
            ...
            jQuery(".chr_detail_social a").attr("href", chr_data[i]['social_channel']);
            jQuery(".chr_detail_social a").text(chr_data[i]['social_channel']);
         ...
         jQuery(document).on("click","a.chr_detail_link",function(e){
          ...
          var ci = jQuery(this).attr('chr-data');
            ...
            jQuery('.chr_descrip p').html(chr_data[ci]['ch_descrip']);
            ...
            jQuery(".chr_detail_social a").attr("href", chr_data[ci]['ch_social_1_url']);
            jQuery(".chr_detail_social a i").attr('class', 'fa fa-' + chr_data[ci]['ch_social_1']);
            jQuery(".chr_detail_social a:nth-of-type(2)").attr('href', chr_data[ci]['ch_social_2_url']);
            jQuery(".chr_detail_social a:nth-of-type(2) i").attr('class', 'fa fa-' + chr_data[ci]['ch_social_2']);
            jQuery(".chr_detail_social a:nth-of-type(3)").attr('href', chr_data[ci]['ch_social_3_url']);
            jQuery(".chr_detail_social a:nth-of-type(3) i").attr('class', 'fa fa-' + chr_data[ci]['ch_social_3']);
            jQuery(".minitries_col .stime_ministries ul li:first-of-type").text(chr_data[ci]['ch_ministries_1']);
            jQuery(".minitries_col .stime_ministries ul li:nth-of-type(2)").text(chr_data[ci]['ch_ministries_2']);
            jQuery(".minitries_col .stime_ministries ul li:nth-of-type(3)").text(chr_data[ci]['ch_ministries_3']);
            jQuery(".minitries_col .stime_ministries ul li:nth-of-type(4)").text(chr_data[ci]['ch_ministries_4']);
            jQuery(".minitries_col .stime_ministries ul li:nth-of-type(5)").text(chr_data[ci]['ch_ministries_5']);
            // jQuery(window).resize();
...
function destroyCarousel() {
  if (jQuery('.chr_detail_slider_div .chr_detail_carousel').hasClass('slick-initialized')) {
    jQuery('.chr_detail_slider_div .chr_detail_carousel').slick('destroy');
  }
}
